...
export const selectTotalResult = (state) => selectPeopleListState(state).totalResults;
export const selectStatus = (state) => selectPeopleListState(state).status;
export const selectTotalPeoplePages = (state) => selectPeopleListState(state).totalPages;
